...
include_once("../includes/Header.php");
    ...
    if(isset($_POST['btnSubmit'])){
        ...
        $isbloqued= $_POST['isbloqued'];
        $datecreation= $_POST['datecreation'];

        $req = "INSERT into utilisateur(username,password,nom,prenom,email,type,isactif,isbloqued,datecreation)
        values(:username,:password,:nom,:prenom,:email,:type,:isactif,:isbloqued,:datecreation)";

        $val= $con->prepare($req);

        $val->bindParam(":username",$username);
        $val->bindParam(":password",$password);
        $val->bindParam(":nom" , $nom);
        $val->bindParam(":prenom",$prenom);
        $val->bindParam(":email",$email);
        $val->bindParam(":type",$type);
        $val->bindParam(":isactif",$isactif);
        $val->bindParam(":isbloqued",$isbloqued);
        $val->bindParam(":datecreation",$datecreation);
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="menu-item-has-children dropdown">
                    ...
                    <ul class="sub-menu children dropdown-menu">
                        <li><i class="menu-icon fa fa-th"></i><a href="creationcompte.php">Creation compte</a></li>
                        <li><i class="menu-icon fa fa-th"></i><a href="listeComptes.php">liste utilisateur</a></li>
                    </ul>
                </li>
...
<div id="right-panel" class="right-panel">
    ...
    <div class="container mt-3" style="width: 60%;">
        ...
        <div class="card">
            <div class="card-header"><strong>Creer nouveau compte</strong><small> Form</small></div>
            <div class="card-body card-block">
                <form action="" method="POST">
                    <div class="form-group">
                        <label for="username" class=" form-control-label">username</label>
                        <input type="text" name="username" placeholder="Entrer username" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="password" class=" form-control-label">password</label>
                        <input type="password" name="password" placeholder="Enter mot de passe" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="prenom" placeholder="Enter votre prenom" class="form-control">
                    </div>
                    ...
                    <div class="form-group">
                        <label for="isactif" class=" form-control-label">actif</label>
                        <input type="text" name="isactif" placeholder="Enter actif" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="isbloqued" class=" form-control-label">blocked</label>
                        <input type="text" name="isbloqued" placeholder="Enter blocked" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="datecreation" class=" form-control-label">datecreation</label>
                        <input type="date" name="datecreation" placeholder="Enter datecreation" class="form-control">
                    </div>

                    <button type="submit" name="btnSubmit" class="btn btn-success">creer compte</button>
                </form>
