                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <strong class="card-title">Listes des comptes</strong>
                        </div>
                        <div class="card-body">
                            <?php
                            ...
                            while ($row = $val->fetch(PDO::FETCH_OBJ)) {
                                ...
                                echo         "<td>{$row->type}</td>";
                                echo         "<td>";
                                echo             "<button class='btn btn-success'>modifier</button>&nbsp;";
                                echo             "<button class='btn btn-danger'>supprimer</button>";
                                                    if($row->isactif  == 1){
                                                        echo "<a href='#' onclick='disable({$row->iduser});
                                                        ' class='btn btn-danger btn-sm'>disable</a>";
                                                    }else{
                                                        echo "<a href='#' onclick='enable({$row->iduser});
                                                        ' class='btn btn-danger btn-sm'>enable</a>";
                                                    }
                                echo         "</td>";
                                echo     "</tr>";
                            }
...
<script>
    ...
    function disable(iduser) {
        ...
        if (answer) {
            ...
            window.location = 'disableaccount.php?id=' + iduser;
        }
    }
...
if (answer) {
    // if user clicked ok, 
    // pass the id to delete.php and execute the delete query
    window.location = 'enableaccount.php?id=' + iduser;
}
}
</script>
