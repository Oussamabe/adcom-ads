...
<div id="right-panel" class="right-panel">
    ...
    <div class="container mt-3" style="width: 60%;">
        ...
        <div class="card">
            <div class="card-header"><strong>ajouter annonce vehicule</strong><small> Form</small></div>
            <div class="card-body card-block">
                <form action="" method="POST">
                    <div class="form-group">
                        <label for="modele" class=" form-control-label">modele</label>
                        <input type="text" name="modele" placeholder="Entrer modele" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="kilometrage" class=" form-control-label">kilometrage</label>
                        <input type="text" name="kilometrage" placeholder="Enter kilometrage" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="annoncemodele" class=" form-control-label">annoncemodele</label>
                        <input type="text" name="annoncemodele" placeholder="Enter annoncemodele" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="nbPorte" class=" form-control-label">nb nbPorte</label>
                        <input type="text" name="nbPorte" placeholder="Enter nbPorte" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="puissance" class=" form-control-label">nb puissance</label>
                        <input type="text" name="puissance" placeholder="Enter puissance" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="nbPorte" class=" form-control-label">nb porte</label>
                        <input type="text" name="nbPorte" placeholder="Enter nbPorte" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="main" class=" form-control-label">main</label>
                        <input type="text" name="main" placeholder="Enter main" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="boiteVitesse" class=" form-control-label">boiteVitesse</label>
                        <input type="text" name="boiteVitesse" placeholder="Enter boiteVitesse" class="form-control">
                    </div>
