                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <?php
                                    $req = "select * from annonceimobilier";
                                    $val = $con->prepare($req);
                                    $val->execute();
                                    ...
                                    while ($row = $val->fetch(PDO::FETCH_OBJ)) {
                                        ...
                                        echo "<td>";
                                        echo     "<a href='../CategorieSection/updateImo.php?id={$row->idimo}' class='btn btn-info btn-sm'><i class='fa fa-pencil'></i>update</a>";
                                        echo     "<a href='#' onclick='delete_user({$row->idimo});' class='btn btn-danger btn-sm'><i class='fa fa-trash'></i>delete</a>";
                                        echo "</td>";
                                        echo "</tr>";
                                    }
                                    ?>
...
<script>
    ...
    function delete_user(ID_Client) {
        ...
        if (answer) {
            ...
            window.location = 'deleteannonceIom.php?id=' + ID_Client;
        }
    }
</script>
