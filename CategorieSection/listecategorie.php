        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="menu-icon fa fa-th"></i><a href="../CategorieSection/addcategorie.php">ajouter annonces</a></li>
                            <li><i class="menu-icon fa fa-th"></i><a href="../CategorieSection/listecategorie.php">listes des annonces </a></li>
                        </ul>
                    </li>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Listes des categories</strong>
                            </div>
                            <div class="card-body">
                            <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                ...
                                <?php
                                    ...
                                    while($row = $val->fetch(PDO::FETCH_OBJ)){
                                       echo "<tr>";
                                       echo "<td>{$row->libelleCat}</td>";
                                       echo "<td>{$row->idimo}</td>";
                                       echo "<td>{$row->idveh}</td>";
                                       echo "<td>";
                                       echo     "<a href='' class='btn btn-info btn-sm'><i class='fa fa-pencil'></i>update</a>";
