...
include_once("../includes/Header.php");
    ...
    if(isset($_POST['btnSubmit'])){
        ...
        $req = "INSERT into annonceimobilier(libelle,surface,nbchambre,etage)
        values(:libelle,:surface,:nbchambre,:etage)";
            ...
            <div class="card-body card-block">
                <form action="" method="POST">
                    <div class="form-group">
                        ...
                        <input type="text" name="libelle" placeholder="Entrer libelle" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="surface" class=" form-control-label">surface</label>
                        <input type="text" name="surface" placeholder="Enter surface" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="etage" class=" form-control-label">etage</label>
                        <input type="text" name="etage" placeholder="Enter etage" class="form-control">
                    </div>

                    <div class="form-group">
                        <label for="nbchambre" class=" form-control-label">nb chambre</label>
                        <input type="text" name="nbchambre" placeholder="Enter nbchambre" class="form-control">
                    </div>
